...
import com.yuzhi.fine.base.ui.pulltorefresh.internal.EmptyViewMethodAccessor;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
    ...
    public void updateLoadMoreViewText(List data) {
        ...
        } else if(getRefreshableView().getAdapter().getCount() == 0 && data.isEmpty()) {
            setLoadMoreViewTextNoData();
        } else if(data.size() < RestApiClient.PAGE_SIZE) {
